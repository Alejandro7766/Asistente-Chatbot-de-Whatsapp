...
El workflow de recordatorios funciona de forma separada: una tarea programada (cron) revisa diariamente la hoja de cálculo de citas y envía un aviso por WhatsApp a los clientes con cita al día siguiente.
...
Puedes probar el asistente escribiendo directamente al siguiente número de WhatsApp: [+48 881 754 990](https://wa.me/48881754990). Se trata de un entorno de demostración orientado al caso de uso de una clínica ficticia; las respuestas no corresponden a un negocio real en producción.
